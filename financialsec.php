<?php
 ...
 // $query = "SELECT  * FROM candidate WHERE position='Financial secretary'";
  $query="SELECT candidate_post.candidateID,candidate_post.postID, `Fname`, `Lname`, `Department`, post.position FROM `candidate`, `post`,`candidate_post` WHERE candidate_post.candidateID=candidate.candidateID AND post.postID=candidate_post.postID AND post.position='Financial secretary'";
...
echo"<a href='vicepresident.php?voterid=".urlencode($voterid)."' class='list-group-item'>Vice-President</a>"; 
echo"<a href='treasurer.php?voterid=".urlencode($voterid)."' class='list-group-item'>Treasurer</a>"; 
echo"<a class='list-group-item'>Financial Secretary</a>";
?>
</div> 
  <div class="col-lg-8">
    <ol class="breadcrumb"> <li><a href="#">Home</a></li>  
	<li class="active">ONLINE POLLING BOOTH</li> </ol>
                   ...
                   <table class="table">
                	...
                	<tbody>
                	 <?php
                	     ...
                	     echo"<td><a href='processfinsec.php?id=".urlencode($id)." &voterid=".urlencode($voterid)."' class='btn btn-success' role='button'>VOTE</a></td></tr>";

<?php
 ...
 $query="SELECT candidate_post.candidateID,candidate_post.postID, `Fname`, `Lname`, `Department`, post.position FROM `candidate`, `post`,`candidate_post` WHERE candidate_post.candidateID=candidate.candidateID AND post.postID=candidate_post.postID AND post.position='President'";
...
<?php
echo"<a class='list-group-item'>President</a>"; 
                   ...
                   <table class="table">
                	...
                	<tbody>
                	 <?php
                	     ...
                	     echo"<td><a href='processpresident.php?id=".urlencode($id)." &voterid=".urlencode($voterid)."' class='btn btn-success' role='button'>VOTE</a></td></tr>";
